...
<main id="main-content">
    ...
    <section class="legal-container">
        ...
        <p>Les données personnelles collectées via le site sont nécessaires à :</p>
        ...
        <p>
            ...
            <strong>Vite & Gourmand SARL</strong>.
        </p>
        ...
        <p>
            Les Conditions Générales de Vente (CGV) applicables aux prestations
            proposées par Vite & Gourmand sont accessibles depuis une page dédiée
            du site.
        </p>
        ...
        <p>
            Vite & Gourmand SARL s'efforce de fournir des informations exactes
            et à jour. Toutefois, la société ne saurait être tenue responsable
            d'erreurs, d'omissions ou d'une indisponibilité temporaire du site.
        </p>
