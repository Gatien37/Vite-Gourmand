...
class CommandeService
{
    ...
    public function __construct(PDO $pdo, CommandeRepository $commandeRepository, MenuRepository $menuRepository)
    {
        $this->pdo = $pdo;
    ...
    public function traiterCommande(array $menu, array $post, array $utilisateur): array
    {
        ...
        try {
            ...
            $this->menuRepository->ajusterStockMenu((int)$menu['id'], $nb);
